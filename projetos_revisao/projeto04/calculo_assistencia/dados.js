    ...
    "Notebook": {
        ...
        "Apple": {
            ...
            "MacBook Pro 13 2019": {
                ...
                "macpro132019_ssdram": { nome: "Troca/Upgrade de SSD ou Memória", sMax: 300, sMin: 200 },
                "macpro132019_limpeza": { nome: "Limpeza Completa + Manutenção Térmica", sMax: 350, sMin: 230 }
            },

            "MacBook Pro 13 M1": {
                "macpro13m1_formatacao": { nome: "Formatação + Backup", sMax: 420, sMin: 300 },
                "macpro13m1_tela": { nome: "Troca de Tela Retina", sMax: 500, sMin: 350 },
                "macpro13m1_bateria": { nome: "Troca de Bateria", sMax: 330, sMin: 230 },
                "macpro13m1_ssdram": { nome: "Upgrade de SSD/Memória - Avaliação", sMax: 320, sMin: 220 },
                "macpro13m1_limpeza": { nome: "Limpeza Completa + Manutenção Térmica", sMax: 380, sMin: 260 }
            },

            "MacBook Pro 14 M1 Pro": {
                "macpro14m1pro_formatacao": { nome: "Formatação + Backup", sMax: 480, sMin: 340 },
                "macpro14m1pro_tela": { nome: "Troca de Tela Retina XDR", sMax: 600, sMin: 420 },
                "macpro14m1pro_bateria": { nome: "Troca de Bateria", sMax: 380, sMin: 260 },
                "macpro14m1pro_ssdram": { nome: "Upgrade de SSD/Memória - Avaliação", sMax: 380, sMin: 250 },
                "macpro14m1pro_limpeza": { nome: "Limpeza Completa + Manutenção Térmica", sMax: 450, sMin: 300 }
            },

            "MacBook Pro 16 M1 Pro": {
                "macpro16m1pro_formatacao": { nome: "Formatação + Backup", sMax: 500, sMin: 350 },
                "macpro16m1pro_tela": { nome: "Troca de Tela Retina XDR", sMax: 650, sMin: 450 },
                "macpro16m1pro_bateria": { nome: "Troca de Bateria", sMax: 400, sMin: 280 },
                "macpro16m1pro_ssdram": { nome: "Upgrade de SSD/Memória - Avaliação", sMax: 400, sMin: 270 },
                "macpro16m1pro_limpeza": { nome: "Limpeza Completa + Manutenção Térmica", sMax: 480, sMin: 320 }
            },

            "MacBook Pro 14 M2 Pro": {
                "macpro14m2pro_formatacao": { nome: "Formatação + Backup", sMax: 500, sMin: 350 },
                "macpro14m2pro_tela": { nome: "Troca de Tela Retina XDR", sMax: 650, sMin: 450 },
                "macpro14m2pro_bateria": { nome: "Troca de Bateria", sMax: 400, sMin: 280 },
                "macpro14m2pro_ssdram": { nome: "Upgrade de SSD/Memória - Avaliação", sMax: 400, sMin: 270 },
                "macpro14m2pro_limpeza": { nome: "Limpeza Completa + Manutenção Térmica", sMax: 480, sMin: 320 }
            },

            "MacBook Pro 16 M2 Pro": {
                "macpro16m2pro_formatacao": { nome: "Formatação + Backup", sMax: 520, sMin: 360 },
                "macpro16m2pro_tela": { nome: "Troca de Tela Retina XDR", sMax: 700, sMin: 480 },
                "macpro16m2pro_bateria": { nome: "Troca de Bateria", sMax: 420, sMin: 290 },
                "macpro16m2pro_ssdram": { nome: "Upgrade de SSD/Memória - Avaliação", sMax: 420, sMin: 280 },
                "macpro16m2pro_limpeza": { nome: "Limpeza Completa + Manutenção Térmica", sMax: 500, sMin: 340 }
            }
        }
    }
};